      ...
      >
        <p className="lg:text-sm md:text-base text-sm">
          ...
          <NavLink to="/datenschutz">
            <a className="text-[#237ee6]">Datenschutzerklärung</a>
          </NavLink>
        </p>
        <div className="flex text-sm my-6 space-x-6">
          <NavLink to="/datenschutz">
            <a className="text-[#237ee6] underline">Datenschutz</a>
          </NavLink>
          <NavLink to="/impressum">
            <a className="text-[#237ee6] underline">Impressum</a>
          </NavLink>
        </div>
        <div className="flex md:flex-row flex-col md:space-y-0 space-y-4 md:justify-between">
          <div
            onClick={handleCancel}
            className="md:w-[16rem] w-full text-center py-2.5 bg-[#237ee6] text-white hover:cursor-pointer transition-all ease-in-out duration-200 hover:bg-opacity-90"
          >
            Einstellungen oder ablehnen
          </div>
          <div
            onClick={aceptCookie}
            style={{ border: '1px solid #237ee6' }}
            className="md:w-[16rem] w-full text-center py-2.5 text-[#237ee6] hover:cursor-pointer transition-all ease-in-out duration-200 hover:bg-opacity-90"
          >
            Alles Akzeptieren
          </div>
        </div>
